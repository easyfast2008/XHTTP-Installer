...
# =============================================================
# Usage: bash <(curl -fsSL https://raw.githubusercontent.com/easyfast2008/XHTTP-Installer/codex/fix-acme-vercel-handling/install.sh)
...
BRANCH="codex/fix-acme-vercel-handling"
